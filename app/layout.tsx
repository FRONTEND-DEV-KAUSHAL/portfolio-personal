...
export const metadata: Metadata = {
  title: "Kaushal Gohil | Full Stack Web Developer Portfolio",
  description: "Official portfolio of Kaushal Gohil - Full Stack Web Developer (MERN / MEAN) & AI-Integrated Applications specialist.",
  generator: "v0.app",
  icons: {
    icon: [
      {
