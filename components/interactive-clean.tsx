...
// Se você quiser customizar com seu próprio código (ex: print de código com bug vs limpo),
// basta colocar as imagens na pasta public/images/ e atualizar os caminhos abaixo.
...
export function InteractiveClean() {
  ...
  useEffect(() => {
    ...
    dirtyImg.src = "/images/code_buggy.png"
    dirtyImg.onload = () => {
    ...
    cleanImg.src = "/images/code_clean.png"
    cleanImg.onload = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isHovered && (
          <motion.div
            className="absolute z-50 pointer-events-none rounded-full overflow-hidden border-2 border-[#c8f550] shadow-2xl"
            style={{
              width: 120,
              height: 120,
              x: cursorPos.x - 60,
