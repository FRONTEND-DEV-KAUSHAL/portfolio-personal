            ...
            <div className="relative">
              ...
              <blockquote className="relative z-10 max-w-xl">
                <p className="text-4xl md:text-5xl lg:text-6xl font-black uppercase text-lorenzo-text-light leading-[1.1] tracking-tight mb-8">
                  ...
                  <span className="block mb-2">ABOUT WRITING</span>
                  ...
                  <span className="block">COMMIT.</span>
                </p>
              </blockquote>

              {/* Author attribution */}
              <div className="mt-4">
                <p className="text-base font-medium font-mono md:text-lg text-accent">- Kaushal Gohil</p>
              </div>
            </div>
          </div>
