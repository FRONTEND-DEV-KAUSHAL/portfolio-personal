...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const helmets = document.getElementById("projects")
      if (helmets) {
      ...
      const techSpecs = document.getElementById("skills")
      if (techSpecs) {
    ...
    <>
      ...
      >
        <div className="mx-auto px-6 md:px-12 flex items-center justify-between h-16">
          ...
          >
            <h1
              className={`font-brier text-3xl md:text-4xl leading-none mt-1 tracking-tight font-bold transition-colors duration-300 ${
